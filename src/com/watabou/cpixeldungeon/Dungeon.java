...
import com.watabou.cpixeldungeon.actors.buffs.Amok;
import com.watabou.cpixeldungeon.actors.buffs.Light;
import com.watabou.cpixeldungeon.actors.hero.Hero;
import com.watabou.cpixeldungeon.actors.hero.HeroClass;
import com.watabou.cpixeldungeon.actors.mobs.npcs.Blacksmith;
import com.watabou.cpixeldungeon.actors.mobs.npcs.Ghost;
import com.watabou.cpixeldungeon.actors.mobs.npcs.Imp;
import com.watabou.cpixeldungeon.actors.mobs.npcs.Wandmaker;
import com.watabou.cpixeldungeon.items.Ankh;
import com.watabou.cpixeldungeon.items.potions.Potion;
import com.watabou.cpixeldungeon.items.rings.Ring;
import com.watabou.cpixeldungeon.items.scrolls.Scroll;
import com.watabou.cpixeldungeon.items.wands.Wand;
import com.watabou.cpixeldungeon.levels.CavesBossLevel;
import com.watabou.cpixeldungeon.levels.CavesLevel;
import com.watabou.cpixeldungeon.levels.CityBossLevel;
import com.watabou.cpixeldungeon.levels.CityLevel;
import com.watabou.cpixeldungeon.levels.DeadEndLevel;
import com.watabou.cpixeldungeon.levels.HallsBossLevel;
import com.watabou.cpixeldungeon.levels.HallsLevel;
import com.watabou.cpixeldungeon.levels.LastLevel;
import com.watabou.cpixeldungeon.levels.LastShopLevel;
import com.watabou.cpixeldungeon.levels.Level;
import com.watabou.cpixeldungeon.levels.PrisonBossLevel;
import com.watabou.cpixeldungeon.levels.PrisonLevel;
import com.watabou.cpixeldungeon.levels.Room;
import com.watabou.cpixeldungeon.levels.SewerBossLevel;
import com.watabou.cpixeldungeon.levels.SewerLevel;
import com.watabou.cpixeldungeon.scenes.GameScene;
import com.watabou.cpixeldungeon.scenes.StartScene;
import com.watabou.cpixeldungeon.utils.BArray;
...
public class Dungeon {
	...
	private static final String RG_GAME_FILE	= "game.cht";
	private static final String RG_DEPTH_FILE	= "depth%d.cht";
	
	private static final String WR_GAME_FILE	= "warrior.cht";
	private static final String WR_DEPTH_FILE	= "warrior%d.cht";
	
	private static final String MG_GAME_FILE	= "mage.cht";
	private static final String MG_DEPTH_FILE	= "mage%d.cht";
	
	private static final String RN_GAME_FILE	= "ranger.cht";
	private static final String RN_DEPTH_FILE	= "ranger%d.cht";
