...
import com.watabou.cpixeldungeon.GamesInProgress;
import com.watabou.cpixeldungeon.actors.Actor;
import com.watabou.cpixeldungeon.actors.Char;
import com.watabou.cpixeldungeon.actors.buffs.Barkskin;
import com.watabou.cpixeldungeon.actors.buffs.Bleeding;
import com.watabou.cpixeldungeon.actors.buffs.Blindness;
import com.watabou.cpixeldungeon.actors.buffs.Buff;
import com.watabou.cpixeldungeon.actors.buffs.Burning;
import com.watabou.cpixeldungeon.actors.buffs.Charm;
import com.watabou.cpixeldungeon.actors.buffs.Combo;
import com.watabou.cpixeldungeon.actors.buffs.Cripple;
import com.watabou.cpixeldungeon.actors.buffs.Fury;
import com.watabou.cpixeldungeon.actors.buffs.GasesImmunity;
import com.watabou.cpixeldungeon.actors.buffs.Hunger;
import com.watabou.cpixeldungeon.actors.buffs.Invisibility;
import com.watabou.cpixeldungeon.actors.buffs.Light;
import com.watabou.cpixeldungeon.actors.buffs.Ooze;
import com.watabou.cpixeldungeon.actors.buffs.Paralysis;
import com.watabou.cpixeldungeon.actors.buffs.Poison;
import com.watabou.cpixeldungeon.actors.buffs.Regeneration;
import com.watabou.cpixeldungeon.actors.buffs.Roots;
import com.watabou.cpixeldungeon.actors.buffs.SnipersMark;
import com.watabou.cpixeldungeon.actors.buffs.Weakness;
import com.watabou.cpixeldungeon.actors.mobs.Mob;
import com.watabou.cpixeldungeon.effects.CheckedCell;
import com.watabou.cpixeldungeon.effects.Flare;
import com.watabou.cpixeldungeon.effects.Speck;
import com.watabou.cpixeldungeon.items.Amulet;
import com.watabou.cpixeldungeon.items.Ankh;
import com.watabou.cpixeldungeon.items.DewVial;
import com.watabou.cpixeldungeon.items.Dewdrop;
...
import com.watabou.cpixeldungeon.items.Heap.Type;
import com.watabou.cpixeldungeon.items.armor.Armor;
import com.watabou.cpixeldungeon.items.keys.GoldenKey;
import com.watabou.cpixeldungeon.items.keys.IronKey;
import com.watabou.cpixeldungeon.items.keys.Key;
import com.watabou.cpixeldungeon.items.keys.SkeletonKey;
import com.watabou.cpixeldungeon.items.potions.PotionOfStrength;
import com.watabou.cpixeldungeon.items.rings.RingOfAccuracy;
import com.watabou.cpixeldungeon.items.rings.RingOfDetection;
import com.watabou.cpixeldungeon.items.rings.RingOfElements;
import com.watabou.cpixeldungeon.items.rings.RingOfEvasion;
import com.watabou.cpixeldungeon.items.rings.RingOfHaste;
import com.watabou.cpixeldungeon.items.rings.RingOfShadows;
import com.watabou.cpixeldungeon.items.rings.RingOfThorns;
import com.watabou.cpixeldungeon.items.scrolls.ScrollOfMagicMapping;
import com.watabou.cpixeldungeon.items.scrolls.ScrollOfRecharging;
import com.watabou.cpixeldungeon.items.scrolls.ScrollOfUpgrade;
import com.watabou.cpixeldungeon.items.wands.Wand;
import com.watabou.cpixeldungeon.items.weapon.Weapon;
import com.watabou.cpixeldungeon.items.weapon.melee.MeleeWeapon;
import com.watabou.cpixeldungeon.levels.Level;
import com.watabou.cpixeldungeon.levels.Terrain;
import com.watabou.cpixeldungeon.levels.features.AlchemyPot;
import com.watabou.cpixeldungeon.levels.features.Chasm;
import com.watabou.cpixeldungeon.plants.Earthroot;
import com.watabou.cpixeldungeon.scenes.GameScene;
import com.watabou.cpixeldungeon.scenes.InterlevelScene;
import com.watabou.cpixeldungeon.scenes.SurfaceScene;
import com.watabou.cpixeldungeon.sprites.CharSprite;
import com.watabou.cpixeldungeon.sprites.HeroSprite;
import com.watabou.cpixeldungeon.ui.AttackIndicator;
import com.watabou.cpixeldungeon.ui.BuffIndicator;
import com.watabou.cpixeldungeon.ui.QuickSlot;
import com.watabou.cpixeldungeon.utils.GLog;
import com.watabou.cpixeldungeon.windows.WndMessage;
import com.watabou.cpixeldungeon.windows.WndResurrect;
import com.watabou.cpixeldungeon.windows.WndTradeItem;
...
public class Hero extends Char {
	...
	private static final String TXT_LEAVE = "One does not simply leave cPixel Dungeon.";
	...
	public Hero() {
		...
		if (Cheats.Enabled)
		{
			HP = HT = Cheats.StartingHitPoints;
			STR = Cheats.StartingStrength;
		}
		else
		{
			HP = HT = STARTING_HP;
