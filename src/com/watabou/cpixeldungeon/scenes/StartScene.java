...
import com.watabou.cpixeldungeon.Chrome;
...
import com.watabou.cpixeldungeon.ui.Archs;
import com.watabou.cpixeldungeon.ui.Icons;
import com.watabou.cpixeldungeon.ui.RedButton;
import com.watabou.cpixeldungeon.ui.SimpleButton;
import com.watabou.cpixeldungeon.ui.Window;
import com.watabou.cpixeldungeon.utils.Utils;
import com.watabou.cpixeldungeon.windows.WndList;
import com.watabou.cpixeldungeon.windows.WndOptions;
import com.watabou.cpixeldungeon.windows.WndTitledMessage;
...
public class StartScene extends PixelScene {
	...
	public void create() {
		...
		curClass = null;
		updateClass( HeroClass.values()[cPixelDungeon.lastClass()] );
	...
	private void updateClass( HeroClass cl ) {
		...
		if (cl != HeroClass.HUNTRESS || (Cheats.EnableHuntress() || huntressUnlocked)) {
	...
	private void startNewGame() {
		...
		if (cPixelDungeon.intro()) {
			cPixelDungeon.intro( false );
